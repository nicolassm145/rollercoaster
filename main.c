...
int main()
{
    ...
    double alturas[9] = {altura_ini, 0, 5 * altura_ini / 4, 0, 3 * altura_ini / 4, altura_ini / 2, (1.0 / 2 - 3.0 / 8) * altura_ini, 3 * altura_ini / 8, 3 * altura_ini / 8};
    ...
    for (int i = 0; i < num_trechos; i++)
    {
        ...
        double energia_total = energiaCinetica(massa_atual, velocidade_atual) + energiaPotencial(massa_atual, alturas[i]);
